...
<br>
<br>
<form action="your_order.php" class="order">
                <fieldset>
  ...
  <select name="mushroom" id="mushroom">
    ...
    <option value="audi">Straw Mushroom</option>
                        ...
                        <div class="order-label"><h5>Quantity</h5></div>
                ...
                <fieldset>
                    ...
                    <input type="submit" name="submit" value="Confirm Order" class="btn btn-primary" method="post">
            </fieldset>
